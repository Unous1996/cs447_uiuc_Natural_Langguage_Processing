...
class FST:
    def __init__(self, initialStateName="q0"):
        ...
        self.outputfile = open('./360verbsGuess.txt', 'w+')
                ...
                if SHOW_STATES:
                    ...
                    for tuple in parse:
                        ...
                        if i < len(parse):
                            allParsesAsString += " => "
                    allParsesAsString += "; "
            print(inString, " ==> ", allParsesAsString, file=self.outputfile)
            return True
        else:
            print(inString, " ==> ", "FAIL")
            return False
    ...
    def parseInputFile(self, fileName):
        if os.path.isfile(fileName):
            ...
            print("### ", fraction,  "(", nParses, " out of ", totalStrings, ") parsed", file=self.outputfile)
