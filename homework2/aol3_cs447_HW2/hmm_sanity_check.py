...
if __name__ == "__main__":
    ...
    try:
        ...
        if goldTags == tags:
            ...
            if debug:
                print("To be specific, your answer is:", tags)
        ...
        if debug:
            print("Sentence accuracy:",senAcc)
        # Calculate recall and precision
        nnpPrec = eval.getPrecision('NNP')
        if debug:
            print("The precision of the tag 'NNP' is", nnpPrec)
        if nnpPrec < 0.80:
        ...
        if debug:
            print("The reacll of the tag 'NNP' is", nnpRec)
        if nnpRec < 0.88:
